...
<html lang="en">
	<head>
		...
		<title>Java Tutorial - Methods</title>
					 	...
					 	<div class="panel-heading">
					  	...
					  	<div class="panel-body">
					 		<ul class="nav nav-tabs" role="tablist">
						    	<li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Points to Remember</a></li>
						    	<li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Examples</a></li>
						  	</ul>
						  	<div class="tab-content">
						    	<div role="tabpanel" class="tab-pane active" id="home">
						    		<br/>
						    		<div class="alert alert-info" role="alert"><i class="fas fa-cog fa-spin"></i> Logically Speaking, a Method is a place within the class where the instructions for performing a task are written.</div>
