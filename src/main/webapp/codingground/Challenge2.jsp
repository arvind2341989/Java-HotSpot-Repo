...
<html lang="en">
	<head>
		...
		<title>Coding Ground - Challenge 2</title>
  							...
  							<div class="tab-content">
    							<div role="tabpanel" class="tab-pane active" id="problemStatement">
									<div class="alert alert-info" role="alert">
										<p class="lead">Write Java Code to find out the Difference of Digits of a Two-digit number.</p>
									</div>
									<div class="alert alert-info" role="alert">
										<b>SPECIFICATIONS:</b>
										<ol>
											<li>Define a Java Class by the name DifferenceOfDigits.</li>
											<li>Define a method by the name getDifferenceOfDigits in the class. The method must have one parameter of type int & the method return type must be int.</li>
											<li>If the given parameter value lies in between 10 & 99, then return the difference of digits. For e.g. if value is 73, then return 4.</li>
    							...
    							<div role="tabpanel" class="tab-pane" id="codeEditor">
											    						<div id="editor">class DifferenceOfDigits {
	public int getDifferenceOfDigits(int number) {
		if(number < 0) {
			return -1;
		}
		if(number > 99) {
		...
		return sumOfDigits;
				...
				<div class="col-md-6">
					<div class="panel panel-default">
  						<div class="panel-heading">
    						<button type="button" id="compileButton" onclick="compileSourceCode('DifferenceOfDigits')" class="btn btn-primary btn-block">Compile Source Code</button>
  						</div>
					  	<div class="panel-body">
					...
					<div class="panel panel-default">
  						<div class="panel-heading">
    						<button type="button" id="testCodeButton" onclick="testCode('DifferenceOfDigits')" class="btn btn-primary btn-block" disabled="disabled">Test Code</button>
  						</div>
					  	<div class="panel-body">
					    	<p id="testResults"></p>
					  	</div>
